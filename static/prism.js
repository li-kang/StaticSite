  ...
  var _ = {
    ...
    util: {
      ...
      clone: function deepClone (o, visited) {
        let clone; let id; const type = _.util.type(o)
        visited = visited || {}
    ...
    highlightAllUnder (container, async, callback) {
      ...
      const elements = container.querySelectorAll(env.selector)
    ...
    highlightElement (element, async, callback) {
      // Find language
      let language = 'none'; let grammar; let parent = element
      ...
      const insertHighlightedCode = function (highlightedCode) {
